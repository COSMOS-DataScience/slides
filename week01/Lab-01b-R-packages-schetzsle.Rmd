...
- Install the `beeper` package onto our computer
- Load the `beeper` package into our R environment
...
Good part: We are able to do pretty much anything with R because someone from around the world has developed the package and shared it. 
