---
title: "Welcome"
author: "Babak Shahbaba <br> Zhaoxia Yu"
output: 
...
```{r echo=FALSE, fig.align='center', out.width="30%"}
knitr::include_graphics("img/Yu_profile.jpg")
```
...
```{r echo=FALSE, fig.align='center', out.width="30%"}
knitr::include_graphics("img/Zoey.png")
```
...
```{r echo=FALSE, fig.align='center', out.width="30%"}
knitr::include_graphics("img/SaraTyo.png")
```
...
| Lectures        | Topics 
|-------------|--------
| Week 1      |Exploring Data, Probability, Statistical Inference 
| Week 2      |Statistical Modeling
| Week 3      |Capstone Project, Advanced Topics & Machine Learning
| Week 4      |Capstone Project, Scientific Communication
...
knitr::include_graphics("img/Alzheimer.png")
```
