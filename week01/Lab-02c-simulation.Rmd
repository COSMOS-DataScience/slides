...
```{r eval=FALSE}
sim_unif <- tibble(sim_unif = runif(100000, 0, 10))
...
The **stat = "identity"** argument indicates that the heights of the bars should be taken directly from the Freq variable.
---
