...
author: "<br>Data Science in Biomedical Sciences<br><br>UCI COSMOS 2026<br>Noah Benjamin<br>(adapted material from Sara Tyo and Mine Dogucu)"
footer: ""
format:
  revealjs:
    chalkboard: true
...
![Create a new project](images/new_project.png){width=300px}

## Creating a project in R studio

![Choose a new Quarto project](images/quarto_project.png){width=300px}

## Creating a project in R studio

![Create your new project!!](images/create_project.png){width=300px}
...
- So, lets say we want to access the first element of the `fruits` vector 
...
- We can do this this mathematically, by adding up the values and dividing by how many there are
...
## Let's write our own `my_mean()` function
